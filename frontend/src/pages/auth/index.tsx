...
const AuthForm = () => {
  ...
  async function onLoginSubmit(values: any) {
    ...
    try {
      ...
      setLoginError(extractErrorMessage(err, '登录失败，请稍后重试'))
    }
  }
  ...
  async function onRegisterSubmit(values: any) {
    ...
    try {
      ...
      setRegisterError(extractErrorMessage(err, '注册失败，请稍后重试'))
    }
  }
                    ...
                    <FormItem>
                      <div className="flex items-center space-x-2 pt-2">
                        ...
                        <Label className="text-sm text-muted-foreground">
                          ...
                          >
                            {String(t('common:terms.userAgreement'))}
                          </Link>
                          {' '}
                          &
                          {' '}
                          ...
                          >
                            {String(t('common:terms.privacyPolicy'))}
                          </Link>
                        </Label>
                      </div>
                      <FormMessage />
