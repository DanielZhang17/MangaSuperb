...
import type { ColorMode } from '@/service/types'
import { DEFAULT_COLOR_MODES, DEFAULT_SELECTED_STYLE } from '@/config/preferences'
...
export const styleAtom = atom<string>(DEFAULT_SELECTED_STYLE)
export const aspectRatioAtom = atom<string>('2:3')
export const colorModeAtom = atom<ColorMode>(DEFAULT_COLOR_MODES[0])
...
export const defaultLayoutAtom = atom<string>('auto-grid')
